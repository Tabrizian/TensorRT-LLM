...
class BindKvCacheTransceiver(KvCacheTransceiver):
    ...
    def __init__(self,
        ...
        # Per-PP indexer k-cache layer counts. With a compact indexer pool
        ...
        # smaller than the attention layer counts; the C++ transceiver uses
        # them to compute the indexer-pass transfer layout.
