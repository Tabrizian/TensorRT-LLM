...
struct MlaParams
{
    ...
    {
        bool enabled = false;
        int32_t const* position_ids = nullptr;
        float const* cos_sin_cache = nullptr;
        int32_t heads_per_group = 0;
        int32_t scale_buf_m = 0;
        int64_t fp8_stride_group = 0;
        int64_t fp8_stride_token = 0;
        int64_t scale_stride_group = 0;
        int64_t scale_stride_k = 0;
        bool is_neox = false;
    };
